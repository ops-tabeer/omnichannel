class Api::V1::Accounts::ConversationsController < Api::V1::Accounts::BaseController
  ...
  def toggle_status
    ...
    return render_forbidden('You are not authorized to reopen this conversation') if reopening && !policy(@conversation).reopen?
  ...
  def should_assign_conversation?
    @conversation.status == 'open' && Current.user.is_a?(User) && Current.user.agent? && Current.account_user&.assignment_allowed?
  end
